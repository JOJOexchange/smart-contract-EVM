...
library Errors {
    ...
    string constant CHAINLINK_PRICE_LESS_THAN_0 = "CHAINLINK_PRICE_LESS_THAN_0";
    string constant STALE_PRICE = "STALE_PRICE";
    string constant USDC_CHAINLINK_PRICE_LESS_THAN_0 = "USDC_CHAINLINK_PRICE_LESS_THAN_0";
    string constant USDC_STALE_PRICE = "USDC_STALE_PRICE";
