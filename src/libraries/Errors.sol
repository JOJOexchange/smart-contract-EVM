...
library Errors {
    ...
    string constant INVALID_FUNDING_RATE_KEEPER =
        "JOJO_INVALID_FUNDING_RATE_KEEPER";
    string constant INVALID_LIQUIDATION_EXECUTOR =
        "JOJO_INVALID_LIQUIDATION_EXECUTOR";
    ...
    string constant FAST_WITHDRAW_NOT_ALLOWED =
        "JOJO_FAST_WITHDRAW_NOT_ALLOWED";
    string constant LIQUIDATION_REQUEST_AMOUNT_WRONG =
        "JOJO_LIQUIDATION_REQUEST_AMOUNT_WRONG";
    string constant SELF_LIQUIDATION_NOT_ALLOWED =
        "JOJO_SELF_LIQUIDATION_NOT_ALLOWED";
    string constant SECONDARY_ASSET_ALREADY_EXIST =
        "JOJO_SECONDARY_ASSET_ALREADY_EXIST";
    string constant SECONDARY_ASSET_DECIMAL_WRONG =
        "JOJO_SECONDARY_ASSET_DECIMAL_WRONG";
    string constant ARRAY_LENGTH_NOT_SAME = "JOJO_ARRAY_LENGTH_NOT_SAME";
    string constant POSITION_AMOUNT_REACH_UPPER_LIMIT =
        "JOJO_POSITION_AMOUNT_REACH_UPPER_LIMIT";
    ...
    string constant LIQUIDATOR_NOT_IN_THE_WHITELIST =
        "LIQUIDATOR_NOT_IN_THE_WHITELIST";
