...
contract JUSDBankBorrowTest is JUSDBankInitTest {
    ...
    function testDepositTooMany() public {
        ...
        jusdBank.borrow(100000e6, alice, false);
        jusdBank.withdraw(address(eth), 75000000000000000000, alice, false);
        vm.stopPrank();
    }
    ...
    function testDepositTooManyETH() public {
        ...
        assertEq(maxWithdraweth, 75000000000000000000);
        assertEq(maxWithdrawbtc, 400000000);

        vm.stopPrank();
        btcOracle.setMarkPrice(15000e16);
