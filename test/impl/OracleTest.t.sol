...
contract OperationTest is Test {
    ...
    ConstOracle constOracle = new ConstOracle(30000e6);
    ...
    JOJOOracleAdaptorWstETH jojoOracleAdaptorWstETH =
    ...
    JOJOOracleAdaptorWstETH jojoOracleAdaptorWstETH2 =
        new JOJOOracleAdaptorWstETH(
            address(mockToken1ChainLink),
            20,
            0,
    ...
    JOJOOracleAdaptorWstETH jojoOracleAdaptorWstETH3 =
        new JOJOOracleAdaptorWstETH(
            address(mockToken1ChainLink),
            20,
            86400,
    ...
    JOJOOracleAdaptorWstETH jojoOracleAdaptorWstETH4 =
        new JOJOOracleAdaptorWstETH(
            address(mockToken1ChainLink),
            20,
            86400,
